 ...
 * refusal (503) rather than a generic failure, so absence is an `Option` here. An empty value reads
 * as absent and is refused the same way, never as a secret that matches an empty header.
 */
