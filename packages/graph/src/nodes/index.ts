...
const nodes = defineNodes([
    ...
    },
    {
        ...
        sources: ["packages/db/src/schema.ts", "packages/db/drizzle.config.ts", "packages/db/drizzle/**"],
        status: "in-progress",
    ...
    },
    {
        ...
        sources: ["packages/db/src/client.ts", "packages/db/src/testing.ts"],
        relations: [
    ...
    },
    {
        ...
        sources: ["packages/koa/src/voice.ts", "packages/koa/src/voice.test.ts"],
        relations: [
